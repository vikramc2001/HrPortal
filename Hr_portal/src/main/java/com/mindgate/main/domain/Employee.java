...
public class Employee {
	...
	public Employee(String employeeId, String password, String firstName, String lastName, String gender, long phoneNo,
			String email, Date dateOfBirth, String designation, double salary, String projectId, Project projectDetails,
			String managerId) {
		super();
	...
	public String toString() {
		return "Employee [employeeId=" + employeeId + ", password=" + password + ", firstName=" + firstName
				...
				+ ", projectId=" + projectId + ", projectDetails=" + projectDetails + ", managerId=" + managerId + "]";
	}
