...
//		String projectId = rs.getString("PROJECT_ID");
		...
		Employee employee=new Employee(employeeId, password, firstName, lastName, gender, phoneNo, employeeemail, dateOfBirth, designation, employeeskill1, employeeskill2, employeeskill3, salary, projectId, project, managerId);
		
		Job job=new Job(jobId, jobtitle, jobqualification, jobskill1, jobskill2, jobskill3, projectId, employeeId, requiredEmployees, jobstatus, project, employee);
